...
I have removed all sensitive information, including API keys, account IDs, email addresses, and specific calendar IDs, to ensure this JSON is safe for public use.
