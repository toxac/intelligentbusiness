...
I have removed all sensitive information, including API keys and specific account IDs, to ensure this JSON is safe for public use. The placeholder folder ID has also been removed.
