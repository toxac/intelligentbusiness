...
I have removed all sensitive information, including API keys, account IDs, and specific Airtable base/table IDs, to ensure this JSON is safe for public use.
