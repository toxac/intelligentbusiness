...
I have removed all sensitive information, including API keys, webhook IDs, and specific channel names, from the JSON file to ensure it is safe for public use.
